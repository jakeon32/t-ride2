...
const heroSlides = [
    {
        ...
        image: phoenixImg,
        title: "프리스타일 라이더의 성지",
        desc: <>총 18면의 슬로프 중 6면이 프리스타일 스키 & 스노보드 공식 경기장.<br />보더와 프리스타일 라이더에게 최적화된 환경.</>
    },
    {
        id: 1,
        image: phoenixImg,
        title: "다양한 파크 아이템",
        desc: <>하프파이프, 빅에어, 다양한 레일과 박스까지.<br />실력을 키우고 도전할 수 있는 최고의 환경.</>
    },
    {
        id: 2,
        image: phoenixImg,
        title: "리조트형 복합 시설",
        desc: <>콘도, 호텔, 다이닝 시설까지 완비.<br />스키 후에도 이어지는 편안한 휴식.</>
    }
];
...
const PhoenixPyeongchang: React.FC = () => {
    ...
    const otherResorts = popularResorts.filter(resort => !resort.name.includes("휘닉스"));
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50">
            ...
            <div className="hidden md:block absolute top-24 left-0 w-full z-20 pointer-events-none">
                <div className="max-w-[1216px] mx-auto px-6 md:px-12">
                    <nav className="flex items-center text-sm text-white/80 font-medium pointer-events-auto drop-shadow-md">
                        ...
                        <span className="mx-2 opacity-60">&gt;</span>
                        <span className="text-white">휘닉스 평창</span>
                    </nav>
                </div>
            </div>
            ...
            <StaticDetailHero
                ...
                mainTitle="휘닉스 스노우 파크 (평창)"
                description={<>총 18면의 슬로프 중 6면이 프리스타일 스키 & 스노보드 공식 경기장으로,<br className="hidden md:block" /> 보더·프리스타일 라이더에게 인기 있는 리조트형 스키장입니다.</>}
            />
                    ...
                    <div className="max-w-[1216px] mx-auto px-6 md:px-12">
                        <div className="mb-20 text-center md:text-left">
                            ...
                            <p className="text-slate-500 text-lg md:text-xl max-w-2xl leading-relaxed">
                                서울·인천에서 휘닉스 평창까지. <br className="hidden md:block" />
                    ...
                    <div className="max-w-[1216px] mx-auto px-6 md:px-12 text-center md:text-left">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div>
                                ...
                                <p className="text-slate-600 font-light">강원도 평창군 봉평면 태기로 174<br />휘닉스 평창</p>
                            </div>
                            <div>
