...
const heroSlides = [
    {
        ...
        title: "스키 여행의 베이스캠프",
        desc: <>용평·알펜시아 리조트까지 차량 10분 거리.<br />스키장 접근성과 편안한 숙소를 동시에.</>
    },
    {
        id: 1,
        image: leisurePrivateImg,
        title: "리조트형 호텔 시설",
        desc: <>넓은 객실과 다양한 편의시설.<br />가족·그룹 여행에 최적화된 숙박 환경.</>
    },
    {
        id: 2,
        image: leisurePrivateImg,
        title: "연중무휴 운영",
        desc: <>스키 시즌은 물론 사계절 내내<br />평창의 자연을 즐길 수 있는 휴양지.</>
    }
];
...
const RamadaPyeongchang: React.FC = () => {
    ...
    const otherResorts = popularResorts.filter(resort => !resort.name.includes("라마다"));
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50">
            ...
            <div className="hidden md:block absolute top-24 left-0 w-full z-20 pointer-events-none">
                <Container>
                    <nav className="flex items-center text-sm text-white/80 font-medium pointer-events-auto drop-shadow-md">
                        ...
                        <span className="mx-2 opacity-60">&gt;</span>
                        <Link to="/leisure" className="hover:text-white transition-colors">스키 연계 숙소</Link>
                        <span className="mx-2 opacity-60">&gt;</span>
                        <span className="text-white">라마다 평창</span>
                    </nav>
                </Container>
            </div>
            ...
            <StaticDetailHero
                ...
                mainTitle="라마다 호텔 & 스위트 평창"
                description={<>평창 주요 스키장 인근에 위치한 리조트형 호텔로,<br className="hidden md:block" /> 가족·그룹 여행의 베이스캠프 역할을 하기 좋은 숙소입니다.</>}
            />
                    ...
                    <Container>
                        <div className="mb-20 text-center md:text-left">
                            ...
                            <p className="text-slate-500 text-lg md:text-xl max-w-2xl leading-relaxed">
                                서울·인천에서 라마다 평창까지. <br className="hidden md:block" />
                            ...
                            <div className="group border border-gray-200 rounded-2xl p-8 lg:p-10 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-500 flex flex-col h-full bg-slate-50/50 relative overflow-hidden">
                                ...
                                <ul className="space-y-4 mb-10 flex-grow relative z-10">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-slate-700 font-medium">호텔 바로 앞 하차 (장비 이동 편리)</span>
                                    </li>
                                    <li className="flex items-start">
                                        <div className="bg-blue-100 p-1 rounded-full mr-3 mt-0.5 text-blue-600">
                                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path d="M5 13l4 4L19 7" /></svg>
                    ...
                    <Container className="text-center md:text-left">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div>
                                ...
                                <p className="text-slate-600 font-light">강원도 평창군 대관령면 솔봉로 519<br />라마다 호텔 & 스위트 평창</p>
                            </div>
                            <div>
                                <h4 className="font-bold text-gray-900 mb-3 text-lg">ACCESS</h4>
                                <p className="text-slate-600 font-light">용평리조트 차량 10분<br />알펜시아리조트 차량 10분</p>
                            </div>
                            <div>
                                <h4 className="font-bold text-gray-900 mb-3 text-lg">SEASON</h4>
                                <p className="text-slate-600 font-light">연중무휴<br />(스키 시즌: 11월 하순 ~ 4월 초)</p>
                            </div>
                            <div>
