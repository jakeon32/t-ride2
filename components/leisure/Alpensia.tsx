...
const heroSlides = [
    {
        ...
        image: skiBannerImg,
        title: "평창 동계올림픽의 무대",
        desc: <>2018 평창 동계올림픽 스키점프 경기장을 품은 리조트.<br />올림픽의 감동을 직접 체험해보세요.</>
    },
    {
        id: 1,
        image: skiBannerImg,
        title: "가족 친화형 겨울 여행지",
        desc: <>호텔, 워터파크, 다양한 편의시설까지.<br />온 가족이 함께 즐기는 완벽한 겨울 휴가.</>
    },
    {
        id: 2,
        image: skiBannerImg,
        title: "다양한 슬로프 구성",
        desc: <>초보자부터 상급자까지 만족시키는<br />체계적인 슬로프와 스키 스쿨 프로그램.</>
    }
];
...
const Alpensia: React.FC = () => {
    ...
    const otherResorts = popularResorts.filter(resort => !resort.name.includes("알펜시아"));
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50">
            ...
            <div className="hidden md:block absolute top-24 left-0 w-full z-20 pointer-events-none">
                <div className="max-w-[1216px] mx-auto px-6 md:px-12">
                    <nav className="flex items-center text-sm text-white/80 font-medium pointer-events-auto drop-shadow-md">
                        ...
                        <span className="mx-2 opacity-60">&gt;</span>
                        <span className="text-white">알펜시아</span>
                    </nav>
                </div>
            </div>
            ...
            <StaticDetailHero
                ...
                mainTitle="평창 알펜시아 리조트"
                description={<>2018 평창 동계올림픽 경기장을 품은 리조트로,<br className="hidden md:block" /> 스키·점프 경기장과 호텔·워터파크가 모여 있는 가족 친화형 겨울 여행지입니다.</>}
            />
                    ...
                    <div className="max-w-[1216px] mx-auto px-6 md:px-12">
                        <div className="mb-20 text-center md:text-left">
                            ...
                            <p className="text-slate-500 text-lg md:text-xl max-w-2xl leading-relaxed">
                                서울·인천에서 알펜시아까지. <br className="hidden md:block" />
                    ...
                    <div className="max-w-[1216px] mx-auto px-6 md:px-12 text-center md:text-left">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div>
                                ...
                                <p className="text-slate-600 font-light">강원도 평창군 대관령면 솔봉로 325<br />알펜시아 리조트</p>
                            </div>
                            <div>
